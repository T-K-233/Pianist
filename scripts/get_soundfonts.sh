...
# mkdir -p ./source/pianist/data/soundfonts
...
mv SalamanderGrandPiano-SF2-V3+20200602/SalamanderGrandPiano-V3+20200602.sf2 ./source/pianist/data/SalamanderGrandPiano.sf2
